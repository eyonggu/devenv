...
let s:licenseTag = "\<enter>COPYRIGHT ERICSSON AB 2014\<enter>\<enter>"
let s:licenseTag = s:licenseTag . "THE COPYRIGHT TO THE COMPUTER PROGRAM HEREIN IS THE\<enter>"
let s:licenseTag = s:licenseTag . "PROPERTY OF ERICSSON AB, SWEDEN. THE PROGRAM MAY BE \<enter>"
let s:licenseTag = s:licenseTag . "USED AND/OR COPIED ONLY WITH THE WRITTEN PERMISSION\<enter>"
let s:licenseTag = s:licenseTag . "FROM ERICSSON AB, OR IN ACCORDANCE WITH THE TERMS AND \<enter>"
let s:licenseTag = s:licenseTag . "CONDITIONS STIPULATED IN THE AGREEMENT/CONTRACT UNDER\<enter>"
let s:licenseTag = s:licenseTag . "WHICH THE PROGRAM HAS BEEN SUPPLIED.\<enter>"
